<template>
  <nav class="bg-white px-6 relative shadow-md mb-5">
    <div class="flex flex-row justify-between items-center py-2">
      <h3 class="font-semibold text-3xl text-gray-500">My Todo App</h3>
      <div class="group flex flex-col items-center">
        ...
        <div class="hidden group-hover:block md:block absolute md:static bg-white inset-x-0 top-16 py-3 shadow-md md:shadow-none text-gray-600">
          <div class="flex flex-row justify-center items-center text-center font-semibold text-gray-500">
            <router-link class="px-6 py-1 flex flex-col md:flex-row md:items-center" to="/"> 
            ...
            <router-link class="px-6 py-1 flex flex-col md:flex-row md:items-center" to="/login"> 
            ...
            <router-link class="px-6 py-1 flex flex-col md:flex-row md:items-center" to="/signup"> 
